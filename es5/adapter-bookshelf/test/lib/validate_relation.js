...
var DB = require('../../../../test/fixtures/classes/database');
var BooksModel = require('../../../../test/fixtures/models/books');

var validateRelation = require('../../lib/validate_relation');
...
describe('validateRelation', function () {
  ...
  it('should throw if requested relation doesn\'t exist for model', function () {
    return expect(validateRelation(model, 'nope')).to.be.rejectedWith(/Unable to find/);
  });
